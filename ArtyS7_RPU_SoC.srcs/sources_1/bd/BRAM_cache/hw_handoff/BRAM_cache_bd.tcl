...
################################################################
# This is a generated script based on design: BRAM_cache
#
...
proc create_root_design { parentCell } {
  ...
  set addrb_0 [ create_bd_port -dir I -from 6 -to 0 addrb_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set clkb_0 [ create_bd_port -dir I -type clk clkb_0 ]
  set dina_0 [ create_bd_port -dir I -from 255 -to 0 dina_0 ]
  set dinb_0 [ create_bd_port -dir I -from 255 -to 0 dinb_0 ]
  set douta_0 [ create_bd_port -dir O -from 255 -to 0 douta_0 ]
  set doutb_0 [ create_bd_port -dir O -from 255 -to 0 doutb_0 ]
