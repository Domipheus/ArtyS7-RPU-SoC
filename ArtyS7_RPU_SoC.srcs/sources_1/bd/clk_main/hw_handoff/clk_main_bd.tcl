...
################################################################
# This is a generated script based on design: clk_main
#
...
proc create_root_design { parentCell } {
  ...
  set clk_200MHz_0 [ create_bd_port -dir O -type clk clk_200MHz_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {200000000} \
 ] $clk_200MHz_0
  set clk_core_0 [ create_bd_port -dir O -type clk clk_core_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT4_JITTER {107.567} \
   CONFIG.CLKOUT4_PHASE_ERROR {87.180} \
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {74.25} \
  ...
  connect_bd_net -net clk_wiz_0_clk_100MHz [get_bd_ports clk_100MHz_0] [get_bd_pins clk_wiz_0/clk_100MHz]
  connect_bd_net -net clk_wiz_0_clk_200MHz [get_bd_ports clk_200MHz_0] [get_bd_pins clk_wiz_0/clk_200MHz]
  connect_bd_net -net clk_wiz_0_clk_core [get_bd_ports clk_core_0] [get_bd_pins clk_wiz_0/clk_core]
